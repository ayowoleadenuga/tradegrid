    ...
    <section className="deal-source">
      ...
      <div className="left-deal">
        ...
        <p>
          ...
          <p>
            <strong>
              When you buy through the platform, our partners are offering you
              the lowest possible price from their depos/stores.
            </strong>{' '}
            This is because we’ve equipped our partners with a GPS route
            mapping, demand aggregation and supply chain optimization tool, that
            leverages intelligent programming to deliver significant cost
            savings.
          </p>
        </div>
      {/* right div */}
